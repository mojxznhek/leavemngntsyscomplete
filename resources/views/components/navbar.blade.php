        ...
        <div class="flex items-center justify-between">
            <button>
                <div class="flex items-center space-x-2">
                    <h2 class="text-black dark:text-white font-bold text-2xl">Leave Management System</h2>
                </div>
            </button>
            ...
            <div class="hidden lg:flex lg:items-center gap-x-2">
                ...
                @if (!Auth::check())
                    <a href="/register"
                        class="flex items-center justify-center rounded-md bg-[#ebebf5] text-purple-700 px-6 py-2.5 font-semibold hover:shadow-lg hover:drop-shadow transition duration-200">
                        Register
                    </a>
                @endif
